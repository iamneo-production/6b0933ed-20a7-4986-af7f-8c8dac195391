...
@Component({
  selector: 'app-customereditjob',
  templateUrl: './customereditjob.component.html',
  styleUrls: ['./customereditjob.component.css']
})
export class CustomereditjobComponent implements OnInit {
  form: FormGroup;
